...
def proof_of_work(last_proof):
    ...
    #Keep incrementing the incrementor until it is equal
    #to a number divisible by 9 and the proof of work of the 
...
def mine():
    ...
    #Now we can gether the data needed to create the new block
    new_block_data = {
        'proof-of-work': proof,
